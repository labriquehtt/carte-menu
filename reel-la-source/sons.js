...
const SOUNDS = [
  ...
  ['NEON', '"LA SOURCE" s\'écrit', 'deep cinematic impact hit followed by a neon sign buzzing to life and a marker writing quickly', 2],
...
const CUES = [
  ...
  [127.0, 'NEON', '"La Source." : hit-stop + LA SOURCE s\'écrit'],
