...
cd reel-la-source
node render.js --stills 5,14,22.2 --out out/stills --debug   # images de contrôle (timecode + visage)
...
- Magenta `#FF00FF` réservé à l'écran du mode écran (0–6.6 s), exactement x 60, y 440,
